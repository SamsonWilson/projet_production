      ...
      <Layout>
        ...
        <section id="realisations" className="portfolio-section py-5">
          <Container>
            ...
            {/* <Row xs={1} sm={2} md={3} lg={4} className="g-4 flex-nowrap overflow-auto horizontal-row"> */}
            <Row className="g-4 flex-nowrap overflow-auto horizontal-row">
 {/* flex-nowrap supprimé */}
              {/* Projet 1 */}
              <Col xs={12} sm={6} md={4} lg={3}> {/* d-flex pour s'assurer que les cartes ont la même hauteur */}
