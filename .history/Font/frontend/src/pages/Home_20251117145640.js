      ...
      <Layout>
        ...
        <section id="realisations" className="portfolio-section py-5">
          <Container>
            ...
            <Row className="g-4 horizontal-row">
              {/* (retiré flex-nowrap/overflow-auto pour permettre le retour à la ligne — max 4 cartes par ligne via les props Col) */}
              {/* Projet 1 */}
              <Col xs={12} sm={6} md={3} lg={3} className="d-flex"> {/* d-flex pour s'assurer que les cartes ont la même hauteur (4 cartes par ligne sur md+) */}
              ...
              {/* Projet 2 */}
              <Col xs={12} sm={6} md={3} lg={3} className="d-flex">
                <Card className="h-100 project-card">
                  <div className="card-icon-wrapper">
