      ...
      <Layout>
        ...
        <section id="realisations" className="portfolio-section py-5">
          <Container>
            ...
            {/* Wrapper pour le défilement horizontal - UTILISATION DE VOTRE NOUVELLE CLASSE "horizontal-row" */}
            <div className="horizontal-row"> {/* Nouvelle classe */}
              <Row className="flex-nowrap g-4"> {/* flex-nowrap pour une seule ligne */}
                {/* Projet 1 */}
                <Col className="d-flex portfolio-item"> {/* Ajout de portfolio-item pour cibler avec CSS */}
                ...
                {/* Projet 2 */}
                <Col className="d-flex portfolio-item">
                  <Card className="h-100 project-card">
                    <div className="card-icon-wrapper">
